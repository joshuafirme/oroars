...
// query
$sql = "INSERT INTO `registration`(`Series`,`names`, `username`,'address', 'gender', 'contactno','email', 'password','repeatpassword', 'idpic' ) VALUES (:Series, :Name, :Gender,:ContactNo, :Email, :Password, :Reapeatassword, :IDpicture)";
$q = $db->prepare($sql);
