        ...
        let raw =  {
            "data": {
                "attributes" : {
                    ...
                    currency : "PHP",
                    redirect : {
                        success : `https://137.184.153.241/checkout.php?payment=success&payment_method=gcash&lat=${marker.position.lat()}&lng=${marker.position.lng()}`,
                        failed : "https://137.184.153.241/checkout.php?payment=failed"
                    }
                }
